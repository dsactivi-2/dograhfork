...
mkdir -p custom/guardian/state/snapshots
if [[ ! -f custom/guardian/state/runtime.env ]]; then
  printf '%s\n' '# generated by Guardian' 'DEEPGRAM_BASE_URL=https://api.eu.deepgram.com' > custom/guardian/state/runtime.env
fi
